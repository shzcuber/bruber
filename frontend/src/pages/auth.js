            ...
            <Router>
              <Routes>
                ...
                <Route
                  exact
                  path="/onboarding"
                  element={<Onboarding authUser={authUser} />}
                />
                <Route
                  exact
                  path="/navbar"
                  element={<Navbar authUser={authUser} />}
                />
                <Route
                  exact
                  path="/rides"
                  element={<Rides authUser={authUser} />}
                />
                <Route
                  path="/driver"
                  element={<Driver authUser={authUser} />}
                />
                <Route
                  exact
                  path="/create_ride"
                  element={<CreateRide authUser={authUser} />}
                />
                <Route
                  exact
                  path="/profile"
                ...
                <Route
                  exact
                  path="/upcoming_rides"
                  element={<UpcomingRides authUser={authUser} />}
                />
                <Route
                  exact
                  path="/about"
                  element={<About authUser={authUser} />}
                />
          ...
          <Router>
            <Routes>
              ...
              <Route
                ...
                element={<ForgotPassword authUser={authUser} />}
              />
              <Route
                exact
                path="/about"
